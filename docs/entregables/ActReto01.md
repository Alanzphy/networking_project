...
La red propuesta se organiza mediante segmentación por VLANs. La Red A corresponde a competidores y utiliza VLAN 10. En ella se conectan las cinco salas de cómputo y la expansión de 120 equipos externos. Los jueces utilizan Red T / VLAN 20, el servidor e impresoras se ubican en Red TI / VLAN 30, los reporteros utilizan Red Repos / VLAN 40, los entrenadores Red E / VLAN 50, los invitados Red I / VLAN 60 y las cámaras de monitoreo del evento Red C / VLAN 70. Las cámaras adicionales/rentadas se conectan de forma inalámbrica al SSID OMI-Camaras, asociado a Red C / VLAN 70. No requieren punto de red por cámara, pero sí energía, batería o toma eléctrica posible. La visualización de cámaras se realiza desde acceso técnico autorizado fuera de las VLANs de usuario, sin reservar una IP adicional en Red TI. Para Packet Tracer se agrega VLAN 99 de Administración, con subred `172.23.11.64/28`, destinada a la controladora e infraestructura técnica; esta VLAN no se expone a usuarios del evento.
