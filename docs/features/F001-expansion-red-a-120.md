# F001 - Expansion Red A para 120 equipos externos
...
El campus dispone de 144 equipos de computo fijos en cinco salas, pero el Dia 2 de primaria requiere 264 competidores simultaneos. Faltan 120 equipos para cumplir el calendario oficial sin olas y sin dividir categorias.

## Objetivo

Definir una expansion fisica de Red A para instalar 120 equipos externos adicionales, manteniendo el calendario oficial de dos dias y la competencia completa por categoria.

## Alcance

Incluye:

- Seleccion de Plan A con Sala Borrego para 120 equipos externos.
- Definicion de Plan B contingente con Auditorio Escuela de Ingenieria.
- Integracion de los 120 equipos externos a Red A / VLAN 10.
...
| --- | --- | --- |
| RF-EXP-01 | Red A debe soportar 144 equipos fijos y 120 equipos externos simultaneos. | Alta |
...
- Primaria compite completa en Dia 2 con 264 equipos simultaneos.
- Los 120 equipos externos deben conectarse a Red A / VLAN 10.
...
- Sala Borrego esta disponible como Plan A.
- Existen 120 equipos externos aptos para competencia.

Accion:

- El equipo tecnico conecta Sala Borrego a Red A / VLAN 10, preferentemente por `OMI-Competidores`.

Resultado esperado:

- Red A soporta 264 competidores simultaneos.
- Los 120 equipos externos acceden al servidor de concurso.
- Los 120 equipos externos quedan aislados de redes no autorizadas.
...
- Se activa Plan B con Auditorio Escuela de Ingenieria para los 120 equipos externos.

Resultado esperado:

- El calendario no cambia.
- Red A mantiene capacidad de 264 equipos.

## Impacto en documentos base

| Documento | Cambio requerido |
| --- | --- |
| `00-fuente-de-verdad.md` | Registrar Sala Borrego como Plan A para 120 equipos externos. |
...
- Confirmar energia, mobiliario, APs, uplinks y conectividad WiFi antes del Dia 2.

## Decisiones pendientes

- Validacion fisica final de energia, mobiliario y conectividad WiFi en Sala Borrego.
- Validacion fisica equivalente para Auditorio Escuela de Ingenieria como Plan B.

## Supuestos

- Los 120 equipos externos seran computadoras aptas para competencia.
